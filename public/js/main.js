const translate = {
  pt_BR: {
    ...
    contact: 'CONTATO',
    language: 'IDIOMA',
    aboutBody: `Bem-vindo à Steelplast, uma organização dedicada à excelência e à inovação. 
    Desde a nossa fundação em 2000, temos trabalhado incansavelmente para oferecer soluções 
    ...
    materiais de engenharia que atendam aos mais altos padrões de qualidade, assegurando a 
    satisfação e confiança de nossos clientes.`,
    companyValues2: `Inovação Contínua: Estimulamos a criatividade e a 
    busca constante por soluções inovadoras, visando aprimorar 
    nossos processos e antecipar as necessidades do mercado.`,
    companyValues3: `Conexão Global: Acreditamos na força das conexões globais 
    e na importância de integrar o Brasil ao cenário internacional,
    promovendo um intercâmbio de conhecimentos e tecnologias.`,
    companyValues4: `Relações de Confiança: Valorizamos a transparência 
    e integridade em todas as nossas relações, 
    cultivando parcerias de longo prazo baseadas na confiança mútua e no respeito.`,
  ...
  es_ES: {
    ...
    contact: 'CONTACTO',
    language: 'IDIOMA',
    aboutBody: `Bienvenido a Steelplast, una organización dedicada a la excelencia y la innovación. 
    Desde nuestra fundación en el año 2000, hemos trabajado 
    incansablemente para ofrecer soluciones excepcionales y construir relaciones 
    sólidas con nuestros clientes, colaboradores y socios.`,
    ...
    materiales de ingeniería que cumplan con los estándares de calidad más altos, 
    asegurando la satisfacción y confianza de nuestros clientes.`,
    companyValues2: `Innovación Continua: Estimulamos la creatividad y la búsqueda 
    constante de soluciones innovadoras, con el objetivo de mejorar nuestros procesos y 
    anticipar las necesidades del mercado.`,
    companyValues3: `Conexión Global: Creemos en la fuerza de las conexiones globales y 
...
Vue.component('main-component', {
  ...
  methods: {
    ...
    loadProdukt(material, type){
      window.location.href = '/' + type + '/' + material;
    }
  },
  mounted() {
